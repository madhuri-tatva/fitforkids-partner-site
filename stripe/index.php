...
<?php
$testsecret = "sk_test_fonvwB3OdT4IXyCfLfQIp08u";
$testpublish = "pk_test_207TSdwSvrD2mIyViAGOFgv4";
$livesecret = "sk_live_QGUh9IX1g6ytl2m52Llvysmv";
$livepublish = "pk_live_IYAQM5jbQSYJHqlhg91grIrS";
...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('<?php echo $publish; ?>');
...
// AMOUNT IN LOWEST FORMAT, 3000 IS 30DKK
//
...
/*
    Stripe_Charge::create(array("amount" => 3000,
                                "currency" => "DKK",
                                "card" => $_POST['stripeToken'],
								"description" => $_POST['email']));    // ONE TIME CHARGE
*/
