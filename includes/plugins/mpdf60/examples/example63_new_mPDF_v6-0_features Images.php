...
<p>For more information, and sample image files see <a href="https://www.libpng.org/pub/png/colorcube/gamma-consistency-test.html">https://www.libpng.org/pub/png/colorcube/gamma-consistency-test.html</a></p>
...
<p>The image below is taken from <a href="https://www.w3.org/TR/CSS21/intro.html">https://www.w3.org/TR/CSS21/intro.html</a> and has the gAMA value set to 1.45454   This is probably unintentional and should be 0.45454 which is 1 / 2.2</p>
<p>The image appears differently on IE9/Safari versus Firefox/Opera. To quote from https://www.libpng.org/pub/png/spec/1.2/PNG-Encoders.html "If the source file\'s gamma value is greater than 1.0, it is probably a display system exponent,....and you should use its reciprocal for the PNG gamma."
