    ...
    (function() {
        ...
        window.params = params;
            ...
            var recordingMedia = 'record-video'; //recordingDIV.querySelector('.recording-media');
            var recordingPlayer = recordingDIV.querySelector('video');
            var mediaContainerFormat = 'WebM'; //recordingDIV.querySelector('.media-container-format');

            recordingDIV.querySelector('.custom-recording-button').onclick = function() {
                var button = this;
            ...
            var MY_DOMAIN = 'http://fitforkids.com';
            ...
            function saveToDiskOrOpenNewTab(recordRTC) {
                ...
                recordingDIV.querySelector('.custom-delete-button').parentNode.style.display = 'block';
                ...
                recordingDIV.querySelector('#upload-to-server').onclick = function() {
                    ...
                    uploadToServer(recordRTC, function(progress, fileURL) {
                        if(progress === 'ended') {
                            ...
                            recordingDIV.querySelector('.custom-delete-button').parentNode.style.display = 'none';
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                var upload_url =  'http://www.fitforkids.com/coach-video-upload.php';
