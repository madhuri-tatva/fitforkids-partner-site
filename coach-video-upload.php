...
function selfInvoker()
{
    ...
    */
    ...
    $filePath = dirname( __FILE__ ) . '/uploads/coachvidoes/' . $fileName;
    ...
    $current_coachee_id = 0;
    if($_SESSION['current_coachee_id']){
        $current_coachee_id = $_SESSION['current_coachee_id'];
    }elseif($_SESSION['EmployeeGroup'] == 0 && $_SESSION['coach_id']>0){
        $current_coachee_id = $_SESSION['UserId'];
    }
    $insertAry = array(
        "user_id" => $_SESSION['UserId'],
        "coach_id" => $_SESSION['coach_id'],
        "coachee_id" => $current_coachee_id,
        "video_from" => ($_SESSION['EmployeeGroup'] == 1 || $_SESSION['EmployeeGroup'] == 4) ? 1 : 2, //1=Coach, 2=Users
        "video_file" => $fileName,
        "created_at" => $db->now(),
        "created_by" => $_SESSION['UserId']
    );
    $db->insert('training_videos', $insertAry);
    echo 'success';
}
